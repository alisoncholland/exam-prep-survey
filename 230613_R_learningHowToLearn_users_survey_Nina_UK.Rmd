...
- add extra column at the beginning and add 'users' and 'nonusers'
- combine users & non-users data for each market
...
--------------------
- working directory
- create 2 separate scripts for DACH and UK surveys

UK & DACH surveys:
- add additional columns on 'general approach' (after 'other approach' section). You can use these: 
...
UK surveys only:
- Combine pilot study results

DACH surveys only:
- When renaming columns, add in additional variable under '# what they did to prepare' e.g. 'englishMaterial' for additional option "Ich habe englischsprachige Quellen oder Materialien in meinen Vorbereitungen genutzt"
- update names of competitors

Additional analyses
-------------------
- What additional analyses could we do? E.g. should we merge the answers of the 'general approach' and 'other approach'?
- Why are these additional analyses important? What will they tell us?
- See for reference: https://razzmatazz-coati-48cc.dovetailapp.com/projects/4tyX5O14nrPxyLznDmwLaE/insights/present/2gwwPnr1rsSKktw0ypcyyL 
...
setwd("C:/Users/ninaz/Documents/R analysis/How do we learn")
getwd()
```
...
```{r}
# load data
data <- read_excel("UK_HDWL_survey_results070623_v2.xlsx")
